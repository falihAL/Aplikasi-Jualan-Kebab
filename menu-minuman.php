...
<body>
	...
	<table align="center" class="tabheader">
		<tr>
			<td height="70" width="800" align="center">Menu Minuman</td>
	...
	<div class="card">
		<div class="poster">
			<img src="foto-minuman/<?php echo $data['foto']; ?>">
			<div class="details">
				<h2><?php echo $data['nama']; ?><br><span>Directed by Happy Food</span><span> | Rp. <?php echo number_format($data['harga']); ?></span></h2>
				<div class="tags">
				<span class="fantasy"><a href="ordermin.php?id=<?php echo $data['id']; ?>">Order</a></span>
			</div>
			<div class="info">
				<p>
	...
	<table align="center">
		...
		<tr>
			...
			<td width="10"></td>
			<td height="45" width="100" align="center" class="td">
			<a href="belimin.php">Lihat Orderan</a>
			</td>
		</tr>
		<tr>
			<td height="80"></td>
