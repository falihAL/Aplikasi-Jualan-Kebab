...
<body>
	...
	<p><a href="tambah-minuman.php">[+] Tambah Data Baru</a></p>
	<table align="center">
		...
		<tbody>
			<?php
				...
				<tr>
                    ...
                    <td><img src="foto-minuman/<?php echo $data['foto']; ?>" width="100"></td>
					<td>
						<a href="edit-minuman.php?id=<?php echo $data['id']; ?>">Edit</a> | 
						<a href="hapus-minuman.php?id=<?php echo $data['id']; ?>">Hapus</a>
					</td>
                    </tr>
                <?php $nomor++; } ?>
		</tbody>
